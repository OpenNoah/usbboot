...
KDebugOnlyTrace t("Jz4740_usb");

/////////////////////////////////////////////////////////////////////
// Begin INIT section
#pragma code_seg("INIT")

DECLARE_DRIVER_CLASS(Jz4740_usb, NULL)
/////////////////////////////////////////////////////////////////////
//  Jz4740_usb::DriverEntry
//
//	Routine Description:
...
//			registry.  To locate Jz4740_usb look for:
//			HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Jz4740_usb
//
//	Return Value:
...
NTSTATUS Jz4740_usb::DriverEntry(PUNICODE_STRING RegistryPath)
{
...
/////////////////////////////////////////////////////////////////////
//  Jz4740_usb::LoadRegistryParameters
//
//	Routine Description:
//		Load driver data members from the registry.
// 
...
void Jz4740_usb::LoadRegistryParameters(KRegistryKey &Params)
{
...
//
NTSTATUS Jz4740_usb::AddDevice(PDEVICE_OBJECT Pdo)
{
	t << "AddDevice called\n";
	...
	Jz4740_usbDevice * pDevice = new (
		...
		Jz4740_usbDevice(Pdo, m_Unit);

	if (pDevice == NULL)
	{
		t << "Error creating device Jz4740_usbDevice"
			   << (ULONG) m_Unit << EOL;
	...
	{
		t << "Error constructing device Jz4740_usbDevice"
